...
fn devtool_surfaces() -> Vec<DevtoolSurfaceSpec> {
    vec![
        ...
        DevtoolSurfaceSpec {
            ...
            summary: "Slippi input export inspection with raw and Rust-normalized inputs.",
            cli_commands: &["replay artifacts", "replay trace"],
            gui_section: "InputTrace",
            source_artifacts: &["debug/slippi/*.inputs.json"],
            outputs: &[],
        },
        DevtoolSurfaceSpec {
            id: "slippi_replay",
            ...
            summary: "Replay trace comparison between exported Slippi frames and Rust runtime state.",
            cli_commands: &["replay artifacts", "replay trace", "replay check"],
            gui_section: "SlippiReplay",
            source_artifacts: &["debug/slippi/*.inputs.json", "replays/*.slp"],
